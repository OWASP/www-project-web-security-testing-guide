...
Googling techniques are explained in [Testing: Spiders, Robots, and Crawlers](4.2.1_Conduct_Search_Engine_Discovery_Reconnaissance_for_Information_Leakage_WSTG-INFO-001.md).
