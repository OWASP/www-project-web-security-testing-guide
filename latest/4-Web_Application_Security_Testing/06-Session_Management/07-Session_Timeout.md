...
The same approach seen in the [Testing for logout functionality](06-Logout_Functionality.md) section can be applied when measuring the timeout log out.
