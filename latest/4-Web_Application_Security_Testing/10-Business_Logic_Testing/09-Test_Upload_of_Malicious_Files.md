...
These are discussed further in the [Testing for XML Injection](../07-Injection_Testing/07-Testing_for_XML_Injection.md) guide.
...
- [Testing for XML Injection](../07-Injection_Testing/07-Testing_for_XML_Injection.md)
