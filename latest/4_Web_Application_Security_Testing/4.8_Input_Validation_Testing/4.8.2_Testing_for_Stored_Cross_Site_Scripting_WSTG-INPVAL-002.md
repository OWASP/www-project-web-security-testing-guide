...
The process for identifying stored XSS vulnerabilities is similar to the process described during the [testing for reflected XSS](4.8.1_Testing_for_Reflected_Cross_Site_Scripting_WSTG-INPVAL-001.md).
