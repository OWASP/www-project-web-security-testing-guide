...
More information about this procedure can be found in the section [Testing for User Enumeration and Guessable User Account](../4.4_Identity_Management_Testing/4.4.4_Testing_for_Account_Enumeration_and_Guessable_User_Account_WSTG-IDENT-004.md) and in the section [Testing for Weak password policy](../4.5_Authentication_Testing/4.5.7_Testing_for_Weak_Password_Policy_WSTG-AUTHN-007.md).
