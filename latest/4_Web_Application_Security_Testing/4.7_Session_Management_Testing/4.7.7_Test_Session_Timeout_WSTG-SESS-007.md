...
The same approach seen in the [Testing for logout functionality (WSTG-SESS-006)](4.7.6_Testing_for_Logout_Functionality_WSTG-SESS-006.md) section can be applied when measuring the timeout log out.
